        ...
        <v-container>
            ...
            <v-row wrap align="start" justify="center">
                <v-col cols="12" md="4" v-for="campaign in campaigns.slice(0, 3)" :key="campaign.id">
                    <v-card light elevation="4" min-height="370" class="mt-5 mb-3" :to="{name: 'CampaignShow', params:{id: campaign.id, slug: campaign.slug}}">
            ...
            <v-row justify="center" class="mt-5 mb-3">
                <v-btn x-large dark class="secondary" :to="{name: 'Campaigns'}">View All Campaigns</v-btn>
            </v-row>
        </v-container>
    </div>
</template>
